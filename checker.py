...
class TestCheckGraphOutputs(unittest.TestCase):
    ...
    def test_7vertex_to6_conn_planar(self):
        sort_graphs("g6/graph7.g6", "g6/planar_conn.6.g6", "tests/test_output/7vertex_to6_conn_planarW.g6", "tests/test_output/7vertex_to6_conn_planarWO.g6")
    ...
    def test_6conn_find_planars(self):
        sort_graphs("g6/graph6c.g6", "g6/forbidden_planar_minors.g6", "tests/test_output/6conn_find_planarsW.g6", "tests/test_output/6conn_find_planarsWO.g6")
